...
class DbHelper {
  ...
  Future<void> open() async {
    database = await openDatabase(
        expenseDatabaseName, version: _version, onCreate: (db, version) {
      db.execute(
  ...
  Future<void> addData(String category, String expenseName, String expenseDate, double expense) async {
    // Veritabanını aç
    if (database == null) {
    ...
    await database.insert(
      ...
      conflictAlgorithm: ConflictAlgorithm.replace, // Eğer aynı id ile kayıt varsa güncelle
    );
  }
